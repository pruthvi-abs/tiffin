...
@section('content')
    @php
    $theme_data = App\ThemeSetting::select('tenant_image', 'datetime_format', 'tenant_title', 'tenant_favicon', 'currency', 'order_cutoff_time')
        ...
        <div id="section-main-2-slider" class="section-slider inner-controls">
            ...
            <div class="product-carousel home-tiffins mb-5 mt-3">
                ...
                @foreach ($tiffinproducts as $tiffinproduct)
                    <form id="addToCart" class="addToCart" action="{{ route('addToCart') }}" method="post" role="form">
                        <input type="hidden" class="_token" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" class="products_id" name="products_id" value="{{ $tiffinproduct->id }}">
                        <input type="hidden" class="product_name" name="product_name"
                            value="{{ $tiffinproduct->p_name }}">
                        <input type="hidden" class="product_code" name="product_code"
                            value="{{ $tiffinproduct->p_code }}">
                        <input type="hidden" class="price" name="price" value="{{ $tiffinproduct->price }}">
                        <div class="product block{{ $tiffinproduct->id }}">
                            <div class="product-box">
                              <div class="product-bottom">
                                <div class="product-name">
                                  <h5 class="display-4 mb-5">{{ $tiffinproduct->p_name }}</h5>
                                </div>
                                <div class="custom-home-slider-box">
                                  <div class="box">
                                    ...
                                    <p class="product-prices">
                                        <h5
                                            class="price-was display-5">{{ $theme_data->currency }}{{ $tiffinproduct->price }}</h5>
                                    </p>
                                    <div class="row align-items-center mt-4">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-primary btn-md" data-target="#productModal"
                                                data-toggle="modal">
            ...
            @foreach ($frontslider as $slider)
                <div class="slide box custsilder">
                    <div class="bg-image zooming"><img src="{{ asset('') }}/{{ $frontslider[0]->image }}" alt="">
                    </div>
                    <div class="container v-center">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-outline-primary btn-lg mt-5"
                                    href="{{ $slider->btnlink }}"><span>{{ $slider->btntitle }}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="section bg-light">
        <div class="container">
            ...
            <div class="product-carousel home-tiffins mb-5 mt-3">
                ...
                <?php for ($j = 0; $j < $total; $j++) { ?> <form id="addToCart"
                    class="addToCart" action="{{ route('addToCart') }}" method="post" role="form">
                    <input type="hidden" class="_token" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="product block{{ $products[$j]->id }}">
                        <div class="product-box">
                            <div class="product-top">
                                <img src="{{ asset('') }}{{ $products[$j]->small_image }}" alt=""
                                    class="product-image">
                            </div>
                            <div class="product-bottom">
                                <div class="product-name">
                                ...
                                <div class="row align-items-center mt-4">
                                    <div class="col-sm-5">
                                        <input type="number" name="quantity" min="1" max="100" value="1"
                                            class="form-control required quantity" required>
                                    </div>
                                    <div class="col-sm-7">
                                        <button class="btn btn-outline-secondary btn-sm" data-target="#productModal"
                                            data-toggle="modal">
                                            <span>Add to cart</span>
                                        </button>
                                    </div>
    ...
    <!-- Section - Menu -->
    <section class="section pb-0 protrude cus-pad">
        <div class="container">
            <h3 class="mb-5 mt-5 text-center">Categories</h3>
        </div>
        <!--
      ...
      -->
        ...
        <div class="row dark bg-dark">
            <!-- Menu Sample -->
            <div class="col-sm-12 col-md-4">
                <div class="menu-sample">
                    <a href="{{ url('/letseat') }}">
                        <img src="{{ asset('public/frontend') }}/category/category_menu.png" alt=""
            ...
            <div class="col-sm-12 col-md-4">
                <div class="menu-sample">
                    <a href="{{ url('/catering') }}">
                        <img src="{{ asset('public/frontend') }}/category/category_catering.png" alt=""
                            class="image img-responsive">
                        <h3 class="title">Catering</h3>
                    </a>
                </div>
            ...
            <div class="col-sm-12 col-md-4">
                <div class="menu-sample">
                    <a href="#">
                        <img src="{{ asset('public/frontend') }}/category/category_tiffin.png" alt=""
                            class="image img-responsive">
                        <h3 class="title">Tiffin</h3>
                    </a>
                </div>
