...
<style>
.counterdashboard{background-color: #F7F7F7;}
.main_container .top_nav {display: block;margin-left: 0;background: #EDEDED;}
.container {padding: 20px;}
</style>
<body class="counterdashboard">
  ...
  <div class="container body">
    <div class="main_container">
      ...
      @include('admin.includes.counterfooter')
    </div>
  </div>
<!--
