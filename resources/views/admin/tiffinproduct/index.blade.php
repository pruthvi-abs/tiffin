...
<div class="page-title">
    ...
    <div class="col-md-3 col-sm-3 form-group ">
         ...
         {!! Html::linkRoute('tiffinproduct.create','Add New',[],['class'=>'btn-sm btn btn-primary margin']) !!}
      </div>
    </div>
</div>
...
$(document).ready(function(){
 oTable = $('#datatable').DataTable({
    ...
    "columns": [
        ...
        {data: 'tiffin_preparation_date', name: 'tiffin_preparation_date'},
  ...
  oTable.on('click','.visibilityclick', function(){
    ...
    /*
      ...
      */
          ...
          $.ajax({
            url:'{!! url('/tiffinvisibility') !!}'+'/'+dataid,
            type:'POST',
...
function renderaction(data, type, row){
		    url='{!! url('/tiffinproduct') !!}'+'/'+data+'/edit';
        deleteurl='{!! url('/tiffinproduct') !!}'+'/'+data;
