...
<div class="page-title">
    ...
    <div class="col-md-3 col-sm-3 form-group ">
        ...
        <?php
        /*
         {!! Html::linkRoute('frontslider.create','Add New',[],['class'=>'btn-sm btn btn-primary margin']) !!}
        */
        ?>
      </div>
    </div>
...
$(document).ready(function(){
 oTable = $('#datatable').DataTable({
		"processing": true,
		"serverSide": true,
    "ajax": "{{ route('getFrontslider') }}",
    "aaSorting": [[0, 'asc']],
    "columns": [
        {"bVisible": true, data: 'sr_no', name: 'sr_no'},
        {data: 'image', name: 'image',render: function (data, type, full, meta) {return "<img src=\"" + data + "\" height=\"50\"/>";},},
...
function renderaction(data, type, row){
		    url='{!! url('/frontslider') !!}'+'/'+data+'/edit';
        deleteurl='{!! url('/frontslider') !!}'+'/'+data;
