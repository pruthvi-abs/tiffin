...
<div class="page-title">
		...
		<div class="col-md-3 col-sm-3 form-group ">
			...
			{!! Html::linkRoute('frontslider.index','Back',array(),['class'=>'btn-sm btn bg-purple margin']) !!}
			</div>
		</div>
</div>
<div class="col-md-12">
    {!! Form::open(['route'=>'frontslider.store','method'=>'POST','role'=>'form','id'=>'formsubmit','files'=>'true']) !!}
      <div class="box-body">
				<div class="row">
					<div class="col-md-6">
				 ...
				 <div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" id="input-file-now-custom-1" name="image" class="dropify" data-default-file="" />
							 </div>
						</div>
					</div>
				 <div class="row">
