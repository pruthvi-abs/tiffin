...
<div class="page-title">
		...
		<div class="col-md-3 col-sm-3 form-group ">
			...
			{!! Html::linkRoute('cateringproduct.index','Back',array(),['class'=>'btn-sm btn bg-purple margin']) !!}
			</div>
		</div>
</div>
        	<div class="col-md-12">
			            {!! Form::open(['route'=>'cateringproduct.store','method'=>'POST','role'=>'form','id'=>'formsubmit','files'=>'true']) !!}
			              <div class="box-body">
											<div class="row">
												<div class="col-md-6">
