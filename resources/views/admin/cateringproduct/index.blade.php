...
<div class="page-title">
      ...
      <div class="custom-list">
        <div class="btn-group">
          <label class="">
            <span>{!! Html::linkRoute('cateringproductall','All',array(),['class'=>'btn btn-primary active']) !!}</span>
          </label>
          <label class="">
            <span>{!! Html::linkRoute('cateringproduct.index','Visible',array(),['class'=>'btn btn-primary']) !!}</span>
          </label>
          <label class="">
            <span>{!! Html::linkRoute('cateringproducthide','Hidden',array(),['class'=>'btn btn-primary']) !!}</span>
          </label>
        </div>
      </div>
		</div>
...
$(document).ready(function(){
 oTable = $('#datatable').DataTable({
		"processing": true,
		"serverSide": true,
    "ajax": "{{ route('getCateringproductall') }}",
    "aaSorting": [[0, 'asc']],
    "columns": [
