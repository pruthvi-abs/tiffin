...
<div class="page-title">
    ...
    <div class="col-md-3 col-sm-3 form-group ">
         ...
         {!! Html::linkRoute('maincategory.create','Add New',[],['class'=>'btn-sm btn btn-primary margin']) !!}
      </div>
    </div>
</div>
...
function renderaction(data, type, row){
		    url='{!! url('/maincategory') !!}'+'/'+data+'/edit';
        deleteurl='{!! url('/maincategory') !!}'+'/'+data;
