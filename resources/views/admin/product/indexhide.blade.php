...
<div class="page-title">
      ...
      <div class="custom-list">
        <div class="btn-group">
          ...
          <label class="">
            <span>{!! Html::linkRoute('product.index','Visible',array(),['class'=>'btn btn-primary']) !!}</span>
          </label>
          <label class="">
            <span>{!! Html::linkRoute('producthide','Hidden',array(),['class'=>'btn btn-primary active']) !!}</span>
          </label>
        </div>
      </div>
		</div>
