...
<div class="page-title">
		...
		<div class="col-md-3 col-sm-3 form-group ">
			...
			{!! Html::linkRoute('product.index','Back',array(),['class'=>'btn-sm btn bg-maroon margin']) !!}
			</div>
		</div>
</div>

        	<div class="col-md-12">
		                {!! Form::model($product,['route'=>['product.update',$product->id],'method'=>'PUT','role'=>'form','id'=>'formsubmit','files'=>'true']) !!}
										<div class="box-body">
										 <div class="row">
											 <div class="col-md-6">
