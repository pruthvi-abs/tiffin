            ...
            <tr>
              <td style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: #000;" align="left" valign="top">
                <div style="font-size: 15px; text-align: left;"><br />
                  <p>Dear {{ $name }},</p>
                  <p>Your order id #{{ $order_id }} has been Canceled.</p>
                  <?php if($payment_method=="Paypal"){ ?>
                  <p>You will get your refund 2 to 3 business days. If you not received the amount then please contact to administrator.</p>
                  <?php } ?>
                  <p>Thanks</p>
