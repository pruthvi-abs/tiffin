...
<div class="page-title">
		...
		<div class="col-md-3 col-sm-3 form-group ">
			...
			{!! Html::linkRoute('coupon.index','Back',array(),['class'=>'btn-sm btn bg-maroon margin']) !!}
			</div>
		</div>
</div>

        	<div class="col-md-12">
		                {!! Form::model($coupon,['route'=>['coupon.update',$coupon->id],'method'=>'PUT','role'=>'form','id'=>'formsubmit']) !!}
										<div class="box-body">
			                <div class="row">
												<div class="col-md-6">
 												 ...
 												 <div class="col-md-6">
  									  			<div class="form-group">
  														{!! Form::label('expiry_date','Expiry Date') !!}
															<input type="text" name="expiry_date" value="<?php echo $coupon->expiry_date; ?>" class="datepicker1 form-control required"/>
